...
public class AdminOrderPage extends JDialog {
	...
	private JRadioButton getRbInsert() {
		if (rbInsert == null) {
			...
			rbInsert.setBounds(125, 16, 84, 23);
		}
		return rbInsert;
	}
	...
	private JRadioButton getRbUpdate() {
		if (rbUpdate == null) {
			...
			rbUpdate.setBounds(221, 16, 84, 23);
		}
		return rbUpdate;
	}
	...
	private JRadioButton getRbDelete() {
		if (rbDelete == null) {
			...
			rbDelete.setBounds(329, 16, 84, 23);
		}
		return rbDelete;
	}
	...
	private JLabel getLblNewLabel_1_2() {
		if (lblNewLabel_1_2 == null) {
			...
			lblNewLabel_1_2.setBounds(33, 333, 61, 16);
		}
